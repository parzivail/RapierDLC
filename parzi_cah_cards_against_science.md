Question |
--- |
"It's trivial!"  said the Professor. "It's obviously just a [BLANK]." |
A hurricane named [BLANK]. |
A parasite is an organism that takes [BLANK] away from another organism while it is still living. |
After getting tenure the professor celebrated by [BLANK]. |
After I defended, my adviser gave me [BLANK]. |
After I mixed [BLANK] and [BLANK], it resulted in [BLANK]. |
After Joe forgot to put the [BLANK] under the fume hood, all hell broke loose. |
After much deliberation, IUPAC decided to name the next element [BLANK]ium. |
After pointing the Hubble space telescope at a blank patch of sky for 10 days astronomers were surprised to see [BLANK]. |
All models are wrong, but some are [BLANK]. |
Applied for postdoc, all I got was this lousy [BLANK]. |
As an experiment, I inserted [BLANK] into [BLANK] and discovered [BLANK]. |
As Schrodinger stuffed the cat in the box, he had an awful thought: What if the cat is [BLANK]? |
Astronomers watched excitedly as [BLANK] made its final descent into the black hole. |
Before centrifuging [BLANK], never forget to [BLANK]. |
Best excuse for putting off writing a referee report. |
Better living through [BLANK]. |
Campus lab safety protocol requires you to always put on your [BLANK] bafore doing [BLANK]. |
Can you believe the new Texas textbooks said [BLANK]. |
Carl Linnaeus would have named it. |
Chemical equilibrium was reached when [BLANK]. |
Congratulations! Your fellowship includes a stipend and [BLANK]. |
Creationists hate it when [BLANK]. |
Darwin's Theory of [BLANK] was invalidated by [BLANK]. |
Despite some recent progress, [BLANK] are still struggling to understand [BLANK]. |
Dinosaur bones are really a test of our faith in [BLANK]. |
Don't forget to include [BLANK] in your dissertation acknowledgments. |
Drinking in the lab on a Friday night is usually not a good idea, because [BLANK] tends to be the result. |
Einstein described [BLANK] as "his biggest blunder." |
Einstein was also well respected in the academic community for his studies on [BLANK]. |
Elon Musk's next company to tackle [BLANK]. |
Epigenetics: As easy to understand as [BLANK]. |
Everything I know about science I learned from [BLANK]. |
Further study is required to establish a causal link between [BLANK] and [BLANK]. |
Grad school was going well until I came across [BLANK]. |
Have you considered the effect of [BLANK]? |
Her gravity well tasted surprisingly like [BLANK]. |
Hey! We've discovered [BLANK] on Mars! |
How do you escape a black hole? |
I can't believe I get paid to [BLANK]. |
I can't wait until I never have to [BLANK]. |
I couldn't finish my proposal because I was detained by [BLANK]. |
I don't think the Large Hadron Collider was expecting to discover [BLANK]. |
I hate it when I get busted for [BLANK]. |
I just love doing [BLANK] behind the lab bench ! |
I knew I never should have added [BLANK] to the chemical reaction. |
I knew I should not have used my twins for an experiment when I observed [BLANK]. |
I knew my Ph.D. Defense wasn't going well when [BLANK]. |
I published my first paper in the journal of [BLANK]. |
I was surprised to find that the wormhole led to [BLANK]. |
I will be required to dissect 500 [BLANK] to complete my thesis. |
In hindsight, I shouldn't have put [BLANK] in the autoclave. |
In the darkness of the laser lab, Mary mistook the [BLANK] for a polarimeter. |
In the lab, I dropped the [BLANK] on the [BLANK]. That was a mess. |
It's been said that [BLANK] causes autism. Murderers! |
It's perfectly okay to pipette by mouth, except when using [BLANK]. |
Josiah Willard Gibbs always thought [BLANK] was pretty hot. |
Lady Ada often spent the evening at home with her [BLANK]. |
My lab mates really hated it when I [BLANK] while listening to [BLANK]. |
My paper on [BLANK] couldn't get published in a peer review journal, so I submitted it to [BLANK]. |
